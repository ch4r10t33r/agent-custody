...
1. The hosted log, [issue #6](https://github.com/ch4r10t33r/agent-custody/issues/6), phase 3: the signer as its own process, published checkpoints, and well-known keys fetched with `--log-url`. Phases 1 and 2 are done; it comes before everything below.
