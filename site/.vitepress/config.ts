  ...
  defineConfig({
    ...
    themeConfig: {
      ...
      sidebar: {
        ...
        { text: "Hosted", items: [{ text: "Register", link: "https://app.agent-custody.dev/" }, { text: "The hosted log", link: "/early-access" }, { text: "Security questionnaire", link: "/security" }, { text: "Privacy", link: "/privacy" }, { text: "Terms for early access", link: "/terms" }, { text: "Contact", link: "/contact" }] },
      ] },
