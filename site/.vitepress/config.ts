  ...
  defineConfig({
    ...
    themeConfig: {
      ...
      sidebar: [
        ...
        { text: "Hosted", items: [{ text: "Early access", link: "/early-access" }, { text: "Security questionnaire", link: "/security" }, { text: "Privacy", link: "/privacy" }, { text: "Terms for early access", link: "/terms" }, { text: "Contact", link: "/contact" }] },
      ],
