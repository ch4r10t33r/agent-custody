...
| Backups and restore | Nightly: the key volume and a database dump, kept thirty days. A restore drill is in the [runbook](https://github.com/ch4r10t33r/agent-custody/blob/main/deploy/RUNBOOK.md); the first one has not yet been performed. |
